...
class GoogleSheetsManager:
    def __init__(self, credentials_file='/etc/secrets/credentials.json', spreadsheet_name='Telegram Bot Data'):
...
async def get_comments(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    sheets_manager = context.application.bot_data.get('sheets_manager')
